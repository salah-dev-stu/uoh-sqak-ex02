...
Final values (placeholders — orchestrator will recalibrate before submission):
  group_code = "uoh-sqak"   (Salah Qadah + Andalus Kalash — same pair as HW1)
  self_grade = 85           (lowered from HW1's 90; HW1 actual was 85.54 so 90 over-estimated)
  github     = https://github.com/salah-dev-stu/uoh-sqak-ex02  (confirm with Andalus)
  late       = no

Run:  uv run python scripts/fill_submission_pdf.py
Outputs:
  uoh-sqak-ex02.docx   (filled cover sheet)
  uoh-sqak-ex02.pdf    (final; what each pair member uploads separately to Moodle)
"""
...
TEMPLATE = REPO / "uoh-rl07-ex02-template.docx"

GROUP_CODE = "uoh-sqak"
SELF_GRADE = "85"
EXERCISE_NUMBER = "02"
GITHUB_URL = "https://github.com/salah-dev-stu/uoh-sqak-ex02"
LATE = "no"
